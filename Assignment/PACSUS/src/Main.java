...
public class Main {
	...
	public static void main(String[] args) {
		...
		new Timer(systemStatus, permitList); // Frame, boundary class

		new Barrier(systemStatus, vehicleList); // Frame, boundary class
		// Repeat for as many barriers as required

		new Campus_security(systemStatus, vehicleList); // Frame, boundary class
		// Repeat for as many campus security screens as required

		new Administration_office(systemStatus, vehicleList, permitList); // Frame,
																			// boundary
																			// class
